...
from app.models import User, Part  # Fully qualified path to avoid re-registration
...
# Load CSV
with open(r'C:\Users\seth0\Downloads\UploadUsers.csv', newline='', encoding='utf-8') as csvfile:
